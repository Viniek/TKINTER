...
def system_window():
    if entry_user_name.get() != 'vee' or entry_password.get() != '1234':
        messagebox.showerror('Error', 'user name or password is incorrect')
    if entry_user_name.get() == '' or entry_password.get() == '':
        messagebox.showerror('error', 'all fields are required')
    if entry_user_name.get() == 'vee' and entry_password.get() == '1234':

        top = Toplevel()
        top.geometry('1366x768')
        top.title('Victory Retail Management System')
        ...
        def bill():
            ...
            if entry_name.get() == '' or phone_entry.get() == '':
                ...
                bill_text_area.insert(END, '**********You were served by Njeri**********\n')
